...
- successfully recovered from surgery
- spent time with family
- found some wns related articles to read
...
- set up attendance sheets to keep track of attendance
- figured out how to grade in HuskyCT
- went to the NRE/EEB grad event
